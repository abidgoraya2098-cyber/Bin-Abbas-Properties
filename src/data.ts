import { QuickLink, FAQItem, PropertyListing, SocietyAmenity, SocietyBlockInfo, SocialLinkItem, PromoAdItem, InstalledDeviceRecord } from "./types";
...
export const DEFAULT_PROMO_ADS: readonly PromoAdItem[] = Object.freeze([
  {
    id: "ad-1787518121707",
    type: "image",
    title: "5.10 مرلہ مین روڈ پرائم کمرشل پلاٹ مین پام روڈ پر",
    titleEn: "5.10 Marla Main Palm Road Prime Commercial Plot",
    caption: "مین پام روڈ پر 5.10 مرلہ کا پرائم کمرشل پلاٹ، شاندار بزنس لوکیشن اور فوری منافع بخش سرمایہ کاری۔ فوری خریداری کے لیے رابطہ کریں۔",
    captionEn: "5.10 Marla prime commercial plot on Main Palm Road, ideal business location and high investment return.",
    price: "1 کروڑ 95 لاکھ",
    priceEn: "1.95 Crore",
    location: "مین پام روڈ رائل پام سٹی",
    locationEn: "Main Palm Road, Royal Palm City",
    mediaUrl: "https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&w=1200&q=80",
    thumbnailUrl: "https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&w=400&q=80",
    isActive: true,
    isHot: true,
    createdAt: 1787518121707,
    viewCount: 28
  },
  {
    id: "ad-1787507147748",
    type: "image",
    title: "5 مرلہ پلاٹ بلاک G رائل پام سٹی",
    titleEn: "5 Marla Plot Block G Royal Palm City",
    caption: "بلاک G میں 5 مرلہ کا شاندار رہائشی پلاٹ، بہترین لوکیشن، پوزیشن دستیاب، فوری رہائش کے لیے انتہائی موزوں۔",
    captionEn: "5 Marla residential plot in Block G, ideal location, possession ready, perfect for construction.",
    price: "76 لاکھ",
    priceEn: "76 Lakh",
    location: "بلاک G رائل پام سٹی",
    locationEn: "Block G, Royal Palm City",
    ...
    isActive: true,
    isHot: true,
    createdAt: 1787507147748,
    viewCount: 34
  },
  {
    id: "ad-1787310636099",
    type: "video",
    title: "10.40 مرلہ مین پام سٹی شاندار پلاٹ",
    titleEn: "10.40 Marla Main Palm City Prime Plot",
    caption: "مین پام سٹی پرائم لوکیشن پر بہترین رہائشی و کمرشل پلاٹ، فوری خریداری کے لیے رابطہ کریں۔",
    captionEn: "Prime location plot on Main Palm City. Contact now on WhatsApp to buy.",
    price: "2 کروڑ 30 لاکھ",
    priceEn: "2 Crore 30 Lakh",
    location: "مین پام سٹی، رائل پام سٹی",
    locationEn: "Main Palm City, Royal Palm City",
    mediaUrl: "https://res.cloudinary.com/demo/video/upload/v1787310563/5241031388657682976_x1e7sc.mp4",
    thumbnailUrl: "https://res.cloudinary.com/demo/video/upload/5241031388657682976_x1e7sc.jpg",
    isActive: true,
    isHot: true,
    createdAt: 1787310636099,
    viewCount: 42
  }
]);

export const DEFAULT_INSTALLED_DEVICES: readonly InstalledDeviceRecord[] = Object.freeze([
  {
    id: "dev_admin_faryad_goraya",
    deviceType: "Android",
    deviceModel: "Samsung Galaxy A54",
    os: "Android",
    browser: "Google Chrome Mobile",
    isPwaInstalled: true,
    installDate: 1787100000000,
    installDateFormatted: "2026-08-20, 10:30 AM",
    lastActive: 1787500000000,
    lastActiveFormatted: "2026-08-24, 02:45 PM",
    isOnline: true
  },
  {
    id: "dev_user_gujranwala_01",
    deviceType: "iPhone",
    deviceModel: "Apple iPhone 14 Pro",
    os: "iOS",
    browser: "Mobile Safari",
    isPwaInstalled: true,
    installDate: 1787150000000,
    installDateFormatted: "2026-08-20, 04:15 PM",
    lastActive: 1787510000000,
    lastActiveFormatted: "2026-08-24, 05:20 PM",
    isOnline: true
  },
  {
    id: "dev_user_lahore_02",
    deviceType: "Android",
    deviceModel: "Xiaomi Redmi Note 12",
    os: "Android",
    browser: "Chrome",
    isPwaInstalled: true,
    installDate: 1787200000000,
    installDateFormatted: "2026-08-21, 11:10 AM",
    lastActive: 1787515000000,
    lastActiveFormatted: "2026-08-24, 06:40 PM",
    isOnline: true
  },
  {
    id: "dev_user_islamabad_03",
    deviceType: "PC",
    deviceModel: "Windows PC",
    os: "Windows",
    browser: "Google Chrome",
    isPwaInstalled: false,
    installDate: 1787250000000,
    installDateFormatted: "2026-08-21, 08:30 PM",
    lastActive: 1787518000000,
    lastActiveFormatted: "2026-08-24, 07:15 PM",
    isOnline: true
  }
]);
